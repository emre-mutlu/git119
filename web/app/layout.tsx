...
const rokkitt = Rokkitt({ subsets: ['latin'], weight: ['500'], variable: '--font-rokkitt' });
...
export default function RootLayout({
  ...
  return (
    <html lang="tr" className="dark">
      <body className={`${outfit.variable} ${josefinSlab.variable} ${robotoCondensed.variable} ${rokkitt.variable} font-sans bg-slate-950 text-slate-200 antialiased`}>
        <Navbar />
        {children}
        <ThemeCustomizer />
      </body>
